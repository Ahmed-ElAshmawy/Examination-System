<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Report2.aspx.cs" Inherits="Report2" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder_Main" Runat="Server">
    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource2" DataTextField="Dept_name" DataValueField="Dept_id">
    </asp:DropDownList>
    ...
    <br />
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="View Report" Width="129px" />
    <br />
