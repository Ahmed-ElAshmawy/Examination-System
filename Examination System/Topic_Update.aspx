<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Topic_Update.aspx.cs" Inherits="Topic_Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" Runat="Server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="topic_crs" TypeName="Topic" UpdateMethod="Update_Topic">
        <SelectParameters>
