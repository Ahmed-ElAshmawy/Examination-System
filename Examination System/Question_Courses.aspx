<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster - Copy.master" AutoEventWireup="true" CodeFile="Question_Courses.aspx.cs" Inherits="Question_Courses" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" Height="268px">
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource2" DataTextField="Crs_name" DataValueField="Crs_id" AppendDataBoundItems="True">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Question_Courses" TypeName="Course">
                <SelectParameters>
