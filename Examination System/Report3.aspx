<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Report3.aspx.cs" Inherits="Report3" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder_Main" Runat="Server">
    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource1" DataTextField="St_name" DataValueField="St_id">
    </asp:DropDownList>
    ...
    <br />
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="View Report" Width="106px" />
    <br />
