<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeFile="Instructors Per Course - Copy.aspx.cs" Inherits="Instructors_Per_Course" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" Height="310px">
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="ObjectDataSource1" AllowPaging="True" PageSize="5">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="select_ins_course" TypeName="Instructor">
                <SelectParameters>
