<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeFile="Topic Per Course - Copy.aspx.cs" Inherits="Topic_Per_Course" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder_Links">
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Take Exam" />
</asp:Content>
